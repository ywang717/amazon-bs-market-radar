...
BEGIN
    ...
    SET
        product_type = CASE
            WHEN EXCLUDED.classification_confidence = 'high' AND best_sellers_product_metadata.classification_confidence <> 'high' THEN EXCLUDED.product_type
            WHEN EXCLUDED.classification_confidence = 'medium' AND best_sellers_product_metadata.classification_confidence = 'low' THEN EXCLUDED.product_type
            ELSE best_sellers_product_metadata.product_type
        END,
        classification_confidence = CASE
            WHEN EXCLUDED.classification_confidence = 'high' AND best_sellers_product_metadata.classification_confidence <> 'high' THEN EXCLUDED.classification_confidence
            WHEN EXCLUDED.classification_confidence = 'medium' AND best_sellers_product_metadata.classification_confidence = 'low' THEN EXCLUDED.classification_confidence
            ELSE best_sellers_product_metadata.classification_confidence
        END,
        classification_rule_id = CASE
            WHEN EXCLUDED.classification_confidence = 'high' AND best_sellers_product_metadata.classification_confidence <> 'high' THEN EXCLUDED.classification_rule_id
            WHEN EXCLUDED.classification_confidence = 'medium' AND best_sellers_product_metadata.classification_confidence = 'low' THEN EXCLUDED.classification_rule_id
            ELSE best_sellers_product_metadata.classification_rule_id
        END,
        classification_rule_version = CASE
            WHEN EXCLUDED.classification_confidence = 'high' AND best_sellers_product_metadata.classification_confidence <> 'high' THEN EXCLUDED.classification_rule_version
            WHEN EXCLUDED.classification_confidence = 'medium' AND best_sellers_product_metadata.classification_confidence = 'low' THEN EXCLUDED.classification_rule_version
            ELSE best_sellers_product_metadata.classification_rule_version
        END,
        classification_evidence = CASE
            WHEN EXCLUDED.classification_confidence = 'high' AND best_sellers_product_metadata.classification_confidence <> 'high' THEN EXCLUDED.classification_evidence
            WHEN EXCLUDED.classification_confidence = 'medium' AND best_sellers_product_metadata.classification_confidence = 'low' THEN EXCLUDED.classification_evidence
